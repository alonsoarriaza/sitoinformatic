...
public class AssistantService {
    ...
    public Map<String, Object> buildConfiguration(PCRequirementRequest request) {
        // Validar mínimos de presupuesto según el uso
        ...
        // 2. Separar presupuesto: 75% Hardware, 25% Periféricos 
        ...
        // Bucle de búsqueda con arrastre de dinero sobrante
    ...
    private Component findBestPossible(BigDecimal maxPrice, String category) {
        ...
        return allOfCat.stream()
            ...
            // Si el presupuesto es tan bajo que nada entra, dar la más barata 
    ...
    private Map<String, Double> getPercentages(String use) {
        ...
        switch (use) {
            ...
            case "STREAMING" -> {
                p.put("CPU", 0.35); p.put("GPU", 0.30); p.put("PLACA_BASE", 0.10); 
                p.put("RAM", 0.10); p.put("SSD", 0.07); p.put("PSU", 0.05); p.put("CASE", 0.03);
            }
            default -> { // OFICINA
